...
PROCEDURE DIVISION.
    ...
    *> --- Test: NbtEncode-IntArray ---
    ...
    UnnamedEmptyArray.
        ...
        IF BUFFER = X"FFFF0B00000000FFFFFFFFFFFFFFFFFF" AND OFFSET = 8 AND NBT-ENCODER-LEVEL = 0
            DISPLAY "PASS"
        ELSE
            DISPLAY "FAIL"
        END-IF.
    NamedEmptyArray.
        ...
        IF BUFFER = X"FFFF0B00044461746100000000FFFFFF" AND OFFSET = 14 AND NBT-ENCODER-LEVEL = 0
            DISPLAY "PASS"
        ELSE
            DISPLAY "FAIL"
        END-IF.
