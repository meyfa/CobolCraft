...
WORKING-STORAGE SECTION.
    COPY DD-CLIENTS.
    01 COLOR-WHITE              PIC X(16)                   VALUE "white".
...
PROCEDURE DIVISION USING LK-CLIENT-ID LK-MESSAGE OPTIONAL LK-COLOR LK-MESSAGE-LENGTH.
    IF LK-MESSAGE-LENGTH OMITTED
    ...
    IF LK-COLOR IS OMITTED OR LK-COLOR = SPACES
        CALL "SendPacket-SystemChat" USING LK-CLIENT-ID LK-MESSAGE BYTE-COUNT COLOR-WHITE
    ELSE
...
PROCEDURE DIVISION USING LK-EXCEPT-CLIENT-ID LK-MESSAGE LK-MESSAGE-LENGTH OPTIONAL LK-COLOR.
    ...
    IF LK-COLOR IS OMITTED
        MOVE COLOR-WHITE TO MESSAGE-COLOR
    ELSE
