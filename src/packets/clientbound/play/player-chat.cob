...
LINKAGE SECTION.
    ...
    01 LK-GLOBAL-INDEX              BINARY-LONG.
...
PROCEDURE DIVISION USING LK-CLIENT LK-GLOBAL-INDEX LK-SENDER-UUID LK-SENDER-NAME LK-MESSAGE LK-MESSAGE-LEN.
    ...
    *> global index
    CALL "Encode-VarInt" USING LK-GLOBAL-INDEX PAYLOAD PAYLOADPOS
