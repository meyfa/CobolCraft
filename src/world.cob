    ...
    *> Do not unload spawn chunks
    ...
    PERFORM VARYING CHUNK-INDEX FROM 1 BY 1 UNTIL CHUNK-INDEX > WORLD-CHUNK-COUNT
        IF WORLD-CHUNK-PRESENT(CHUNK-INDEX) > 0
                AND ((WORLD-CHUNK-X(CHUNK-INDEX) < SPAWN-X-START OR > SPAWN-X-END)
                OR (WORLD-CHUNK-Z(CHUNK-INDEX) < SPAWN-Z-START OR > SPAWN-Z-END))
...
WORKING-STORAGE SECTION.
    ...
    01 CHUNK-X              BINARY-LONG.
    01 CHUNK-Z              BINARY-LONG.
    01 SPAWN-AREA-X         BINARY-LONG.
    01 SPAWN-AREA-Z         BINARY-LONG.
