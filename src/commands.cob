...
PROCEDURE DIVISION USING LK-NAME LK-HELP LK-PTR-EXECUTE LK-COMMAND-NODE.
    ...
    CALL "AddCommandNode-Literal" USING OMITTED LK-NAME LK-COMMAND-NODE
...
LINKAGE SECTION.
    ...
    *> node definition
    ...
    01 LK-NODE-PROPERTIES       PIC X ANY LENGTH.
    *> resulting node index
    01 LK-NODE-INDEX            BINARY-LONG UNSIGNED.

PROCEDURE DIVISION USING OPTIONAL LK-PARENT-NODE LK-NODE-TYPE LK-NODE-NAME OPTIONAL LK-NODE-PROPERTIES LK-NODE-INDEX.
    ...
    *> 5 = string parser
    MOVE 5 TO COMMAND-NODE-PARSER(LK-NODE-INDEX)
    IF LK-NODE-PROPERTIES IS NOT OMITTED
        MOVE FUNCTION LENGTH(LK-NODE-PROPERTIES) TO PROPERTIES-LENGTH
        MOVE LK-NODE-PROPERTIES TO COMMAND-NODE-PROPERTIES(LK-NODE-INDEX)(1:PROPERTIES-LENGTH)
...
*> --- AddCommandNode-Literal ---
*> Add a literal argument to a command node.
IDENTIFICATION DIVISION.
PROGRAM-ID. AddCommandNode-Literal.
...
PROCEDURE DIVISION USING OPTIONAL LK-PARENT-NODE LK-NODE-NAME LK-NODE-INDEX.
    IF LK-PARENT-NODE IS OMITTED
        CALL "AddCommandNode" USING OMITTED NODE-TYPE LK-NODE-NAME OMITTED LK-NODE-INDEX
    ELSE
        CALL "AddCommandNode" USING LK-PARENT-NODE NODE-TYPE LK-NODE-NAME OMITTED LK-NODE-INDEX
    END-IF
    GOBACK.

END PROGRAM AddCommandNode-Literal.

*> --- AddCommandArgument-Simple ---
*> Add a simple (one-word) argument to a command node.
IDENTIFICATION DIVISION.
PROGRAM-ID. AddCommandArgument-Simple.

DATA DIVISION.
WORKING-STORAGE SECTION.
    01 NODE-TYPE                BINARY-CHAR UNSIGNED        VALUE 2.
    01 PROPERTY-STRING          PIC X(1)                    VALUE X"00".
LINKAGE SECTION.
    01 LK-PARENT-NODE           BINARY-LONG UNSIGNED.
    01 LK-NODE-NAME             PIC X ANY LENGTH.
    01 LK-NODE-INDEX            BINARY-LONG UNSIGNED.
...
PROCEDURE DIVISION USING OPTIONAL LK-PARENT-NODE LK-NODE-NAME LK-NODE-INDEX.
    IF LK-PARENT-NODE IS OMITTED
        CALL "AddCommandNode" USING OMITTED NODE-TYPE LK-NODE-NAME PROPERTY-STRING LK-NODE-INDEX
    ELSE
        CALL "AddCommandNode" USING LK-PARENT-NODE NODE-TYPE LK-NODE-NAME PROPERTY-STRING LK-NODE-INDEX
    END-IF
    GOBACK.

END PROGRAM AddCommandArgument-Simple.

*> --- AddCommandArgument-Greedy ---
*> Add a greedy (multi-word) argument to a command node.
IDENTIFICATION DIVISION.
PROGRAM-ID. AddCommandArgument-Greedy.

DATA DIVISION.
WORKING-STORAGE SECTION.
    01 NODE-TYPE                BINARY-CHAR UNSIGNED        VALUE 2.
    01 PROPERTY-STRING          PIC X(1)                    VALUE X"02".
LINKAGE SECTION.
    01 LK-PARENT-NODE           BINARY-LONG UNSIGNED.
    01 LK-NODE-NAME             PIC X ANY LENGTH.
    01 LK-NODE-INDEX            BINARY-LONG UNSIGNED.
...
END PROGRAM AddCommandArgument-Greedy.
