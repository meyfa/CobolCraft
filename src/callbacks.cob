...
*> --- SetCallback-WindowGetSlot ---
IDENTIFICATION DIVISION.
PROGRAM-ID. SetCallback-WindowGetSlot.
...
PROCEDURE DIVISION USING LK-WINDOW-TYPE LK-CB-PTR.
    IF LK-WINDOW-TYPE < 0
        MOVE LK-CB-PTR TO CB-PTR-GET-SLOT-PLAYER
        GOBACK
    END-IF
    MOVE LK-CB-PTR TO CB-PTR-GET-SLOT(LK-WINDOW-TYPE + 1)
    GOBACK.

END PROGRAM SetCallback-WindowGetSlot.

*> --- GetCallback-WindowGetSlot ---
IDENTIFICATION DIVISION.
PROGRAM-ID. GetCallback-WindowGetSlot.
...
PROCEDURE DIVISION USING LK-WINDOW-TYPE LK-CB-PTR.
    IF LK-WINDOW-TYPE < 0
        MOVE CB-PTR-GET-SLOT-PLAYER TO LK-CB-PTR
        GOBACK
    END-IF
    MOVE CB-PTR-GET-SLOT(LK-WINDOW-TYPE + 1) TO LK-CB-PTR
    GOBACK.

END PROGRAM GetCallback-WindowGetSlot.
...
*> --- SetCallback-WindowShift ---
IDENTIFICATION DIVISION.
PROGRAM-ID. SetCallback-WindowShift.
...
PROCEDURE DIVISION USING LK-WINDOW-TYPE LK-CB-PTR.
    IF LK-WINDOW-TYPE < 0
        MOVE LK-CB-PTR TO CB-PTR-SHIFT-PLAYER
        GOBACK
    END-IF
    MOVE LK-CB-PTR TO CB-PTR-SHIFT(LK-WINDOW-TYPE + 1)
    GOBACK.

END PROGRAM SetCallback-WindowShift.

*> --- GetCallback-WindowShift ---
IDENTIFICATION DIVISION.
PROGRAM-ID. GetCallback-WindowShift.
...
PROCEDURE DIVISION USING LK-WINDOW-TYPE LK-CB-PTR.
    IF LK-WINDOW-TYPE < 0
        MOVE CB-PTR-SHIFT-PLAYER TO LK-CB-PTR
        GOBACK
    END-IF
    MOVE CB-PTR-SHIFT(LK-WINDOW-TYPE + 1) TO LK-CB-PTR
    GOBACK.

END PROGRAM GetCallback-WindowShift.
