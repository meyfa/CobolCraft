...
PROCEDURE DIVISION USING LK-FAILURE.
    ...
    *> root tag
    MOVE 1 TO OFFSET
    CALL "NbtEncode-RootCompound" USING NBT-BUFFER OFFSET

    *> "Data" tag
    MOVE "Data" TO TAG-NAME
    MOVE 4 TO NAME-LEN
    CALL "NbtEncode-NamedCompound" USING NBT-BUFFER OFFSET TAG-NAME NAME-LEN

    *> "Time": world age
    MOVE "Time" TO TAG-NAME
    MOVE 4 TO NAME-LEN
    CALL "NbtEncode-NamedLong" USING NBT-BUFFER OFFSET TAG-NAME NAME-LEN WORLD-AGE

    *> "DayTime": world time
    MOVE "DayTime" TO TAG-NAME
    MOVE 7 TO NAME-LEN
    CALL "NbtEncode-NamedLong" USING NBT-BUFFER OFFSET TAG-NAME NAME-LEN WORLD-TIME

    *> end "Data" and root tags
    CALL "NbtEncode-End" USING NBT-BUFFER OFFSET
    CALL "NbtEncode-End" USING NBT-BUFFER OFFSET
...
PROCEDURE DIVISION USING LK-FAILURE.
    ...
    *> end of "Data" and root tags
    CALL "NbtDecode-End" USING NBT-DECODER-STATE NBT-BUFFER OFFSET
    CALL "NbtDecode-End" USING NBT-DECODER-STATE NBT-BUFFER OFFSET
