...
PROCEDURE DIVISION.
    ...
    *> TODO Make this simpler and reusable
    ...
    PERFORM VARYING IDX-BLOCK FROM 1 BY 1 UNTIL IDX-BLOCK > TAGS-REGISTRY-TAG-LENGTH(IDX-REGISTRY, IDX-TAG)
        CALL "Blocks-GetStateIds" USING TAGS-REGISTRY-TAG-ENTRY(IDX-REGISTRY, IDX-TAG, IDX-BLOCK) BLOCK-MIN-STATE-ID BLOCK-MAX-STATE-ID
        PERFORM VARYING BLOCK-STATE FROM BLOCK-MIN-STATE-ID BY 1 UNTIL BLOCK-STATE > BLOCK-MAX-STATE-ID
