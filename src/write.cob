...
*> --- Encode-Long ---
*> Encode a 64-bit integer as 8 bytes (big-endian) and store it in a buffer.
*> TODO: support signed longs
IDENTIFICATION DIVISION.
...
PROCEDURE DIVISION USING BY REFERENCE LK-VALUE-IN LK-VALUE-OUT LK-OUT-LENGTH.
    ...
    PERFORM VARYING I FROM 1 BY 1 UNTIL I > LK-OUT-LENGTH
        DIVIDE CURRENT-VALUE BY 256 GIVING CURRENT-VALUE-BYTE REMAINDER CURRENT-VALUE
        MOVE FUNCTION CHAR(CURRENT-VALUE-BYTE + 1) TO LK-VALUE-OUT(I:1)
    END-PERFORM.
