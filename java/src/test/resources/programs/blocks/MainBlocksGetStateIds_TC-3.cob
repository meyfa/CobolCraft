...
PROCEDURE DIVISION.
    ...
    *> Initialize BLOCKS structure with large range test data
    MOVE 1 TO BLOCK-COUNT
    MOVE 1000000 TO BLOCK-ENTRY-MINIMUM-STATE-ID(2)
    MOVE 9999999 TO BLOCK-ENTRY-MAXIMUM-STATE-ID(2)
    
    *> Call the subprogram
    CALL 'Blocks-GetStateIds' USING LK-BLOCK-ID LK-MINIMUM-ID LK-MAXIMUM-ID
    DISPLAY "Blocks-GetStateIds returned minimum=" LK-MINIMUM-ID " maximum=" LK-MAXIMUM-ID
