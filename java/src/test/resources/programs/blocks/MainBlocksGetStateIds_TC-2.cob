...
PROGRAM-ID. MainBlocksGetStateIds_TC-2.
...
PROCEDURE DIVISION.
    DISPLAY "MainBlocksGetStateIds_TC-2 started".
    ...
    *> Initialize BLOCKS structure with test data
    ...
    MOVE 199 TO BLOCK-ENTRY-MAXIMUM-STATE-ID(1)
    MOVE 200 TO BLOCK-ENTRY-MINIMUM-STATE-ID(2)
    MOVE 299 TO BLOCK-ENTRY-MAXIMUM-STATE-ID(2)
    MOVE 300 TO BLOCK-ENTRY-MINIMUM-STATE-ID(3)
    MOVE 399 TO BLOCK-ENTRY-MAXIMUM-STATE-ID(3)
    ...
    *> Write outputs to file
    ...
    GOBACK.
END PROGRAM MainBlocksGetStateIds_TC-2.
