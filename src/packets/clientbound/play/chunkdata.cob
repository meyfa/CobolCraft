    ...
    *> construct chunk data
    ...
    PERFORM VARYING CHUNK-SEC FROM 1 BY 1 UNTIL CHUNK-SEC > 24
        ...
        *> block states
        ...
        ELSE
            CALL "EncodePalette" USING CHUNK-DATA CHUNK-DATA-POS BLOCK-STATES-LENGTH LK-SECTION-BLOCKS(CHUNK-SEC) MAX-BLOCK-STATE-ID
        END-IF
        *> biomes
    ...
    *> --- EncodePalette ---
    ...
    WORKING-STORAGE SECTION.
        *> palette entries are 8-byte signed integers
        ...
        01 LONG-BYTES.
            02 LONG                 BINARY-LONG-LONG UNSIGNED.
    LINKAGE SECTION.
        01 LK-BUFFER                PIC X ANY LENGTH.
        01 LK-BUFFERPOS             BINARY-LONG UNSIGNED.
