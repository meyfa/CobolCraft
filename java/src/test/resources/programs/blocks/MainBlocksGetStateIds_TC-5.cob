...
PROGRAM-ID. Main-Blocks-GetStateIds-TC-5.
...
PROCEDURE DIVISION.
    ...
    *> Initialize BLOCKS structure with fewer entries
    MOVE 2 TO BLOCK-COUNT
    
    *> Call the subprogram
    CALL 'Blocks-GetStateIds' USING LK-BLOCK-ID LK-MINIMUM-ID LK-MAXIMUM-ID
    DISPLAY "Blocks-GetStateIds returned with MINIMUM-ID=" LK-MINIMUM-ID " MAXIMUM-ID=" LK-MAXIMUM-ID
    ...
    *> Write outputs to file
    ...
    GOBACK.
END PROGRAM Main-Blocks-GetStateIds-TC-5.
