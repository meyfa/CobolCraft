*> --- MainBlocksMaximumStateId_TC-2 ---
IDENTIFICATION DIVISION.
PROGRAM-ID. MainBlocksMaximumStateId_TC-2.
...
PROCEDURE DIVISION.
    DISPLAY "MainBlocksMaximumStateId_TC-2 started".
    
    *> Accept result file path from environment
    ACCEPT WS-RESULT-FILE-PATH FROM ENVIRONMENT "RESULT_FILE_PATH"
    
    *> Initialize BLOCKS structure with BLOCKS-MAXIMUM-STATE-ID set to 0
    INITIALIZE BLOCKS-MAXIMUM-STATE-ID
    ...
    *> Write outputs to file
    ...
    GOBACK.
END PROGRAM MainBlocksMaximumStateId_TC-2.
