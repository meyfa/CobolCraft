...
PROCEDURE DIVISION USING LK-HNDL LK-ERRNO LK-CHUNK.
    ...
    *> construct chunk data
    ...
    PERFORM VARYING CHUNK-SEC FROM 0 BY 1 UNTIL CHUNK-SEC >= 24
        CALL "EncodeChunkSection" USING CHUNK-SEC LK-CHUNK-SECTION(CHUNK-SEC + 1) BUFFER BUFFERLEN
    ...
    *> --- EncodeChunkSection ---
    ...
    PROCEDURE DIVISION USING LK-CHUNK-SEC LK-SECTION LK-BUFFER LK-BUFFERLEN.
