...
PROCEDURE DIVISION USING LK-CLIENT LK-CLIENT-STATE LK-PACKET-ID LK-PAYLOAD LK-OFFSET.
    ...
    IF HANDLER-PTR NOT = NULL
        ...
        IF CONSUMED NOT = FUNCTION LENGTH(LK-PAYLOAD)
            ...
            DISPLAY "[state=" LK-CLIENT-STATE "] Packet " FUNCTION TRIM(PACKET-REFERENCE) " handler consumed "
                CONSUMED " of " FUNCTION LENGTH(LK-PAYLOAD) " bytes"
        END-IF
    END-IF
    GOBACK.
