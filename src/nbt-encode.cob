...
PROCEDURE DIVISION USING LK-STATE LK-BUFFER LK-OFFSET OPTIONAL LK-NAME OPTIONAL LK-NAME-LEN LK-VALUE.
    ...
    *> value
    CALL "Encode-Float" USING LK-VALUE TEMP-BUFFER TEMP-BUFFER-LEN
    MOVE TEMP-BUFFER(1:TEMP-BUFFER-LEN) TO LK-BUFFER(LK-OFFSET:TEMP-BUFFER-LEN)
    ADD TEMP-BUFFER-LEN TO LK-OFFSET
...
PROCEDURE DIVISION USING LK-STATE LK-BUFFER LK-OFFSET OPTIONAL LK-NAME OPTIONAL LK-NAME-LEN LK-VALUE.
    ...
    *> value
    CALL "Encode-Double" USING LK-VALUE TEMP-BUFFER TEMP-BUFFER-LEN
    MOVE TEMP-BUFFER(1:TEMP-BUFFER-LEN) TO LK-BUFFER(LK-OFFSET:TEMP-BUFFER-LEN)
    ADD TEMP-BUFFER-LEN TO LK-OFFSET
...
PROCEDURE DIVISION USING LK-STATE LK-BUFFER LK-OFFSET OPTIONAL LK-NAME OPTIONAL LK-NAME-LEN LK-VALUE LK-VALUE-LEN.
    *> If the parent element is a list, update its type and count.
    IF LK-LEVEL > 0 AND LK-STACK-TYPE(LK-LEVEL) = X"09"
...
PROCEDURE DIVISION USING LK-STATE LK-BUFFER LK-OFFSET OPTIONAL LK-NAME OPTIONAL LK-NAME-LEN LK-DATA LK-DATA-LEN.
    CALL "NbtEncode-ByteArray" USING LK-STATE LK-BUFFER LK-OFFSET LK-NAME LK-NAME-LEN LK-DATA-LEN
