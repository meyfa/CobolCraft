...
WORKING-STORAGE SECTION.
    ...
    01 BLOCK-REGISTRY-ID        BINARY-LONG UNSIGNED.
...
PROCEDURE DIVISION.
    ...
    *> TODO Make this simpler and reusable
    ...
    CALL "Registries-LookupRegistry" USING "minecraft:block" BLOCK-REGISTRY-ID
    ...
    PERFORM VARYING IDX-BLOCK FROM 1 BY 1 UNTIL IDX-BLOCK > TAGS-REGISTRY-TAG-LENGTH(IDX-REGISTRY, IDX-TAG)
        *> TODO Avoid so many lookups
        CALL "Registries-EntryName" USING BLOCK-REGISTRY-ID TAGS-REGISTRY-TAG-ENTRY(IDX-REGISTRY, IDX-TAG, IDX-BLOCK) BLOCK-NAME
