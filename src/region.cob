...
PROCEDURE DIVISION USING LK-REGION-X LK-REGION-Z LK-ALLOW-CREATE LK-FAILURE LK-REGION-INDEX.
    ...
    *> At this point, we are guaranteed to have capacity for a new region file at the end
...
OpenFile.
    CALL "Region-RegionFileName" USING LK-REGION-X LK-REGION-Z REGION-FILE-NAME
