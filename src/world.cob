...
PROCEDURE DIVISION USING LK-CHUNK-X LK-CHUNK-Z.
    ...
    *> turn all blocks with Y = 63 (i.e., the top 16x16 blocks) into grass
    ...
    COMPUTE SECTION-INDEX = (127 / 16) + 1
    COMPUTE BLOCK-INDEX = FUNCTION MOD(127, 16) * 16 * 16 + 1
    PERFORM 256 TIMES
        MOVE TEMP-INT32 TO WORLD-BLOCK-ID(CHUNK-INDEX, SECTION-INDEX, BLOCK-INDEX)
    ...
    PERFORM UNTIL SECTION-INDEX = 0
        ...
        NOT AT END
            ...
            *> load the section data
            PERFORM VARYING BLOCK-INDEX FROM 1 BY 1 UNTIL BLOCK-INDEX > 4096
                MOVE BLOCK-STATE-IDS(CHUNK-SECTION-DATA(BLOCK-INDEX) + 1) TO WORLD-BLOCK-ID(CHUNK-INDEX, SECTION-INDEX, BLOCK-INDEX)
            END-PERFORM
