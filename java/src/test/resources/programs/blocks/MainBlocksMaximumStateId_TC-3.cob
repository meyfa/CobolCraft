...
PROGRAM-ID. MainBlocksMaximumStateId_TC-3.
...
PROCEDURE DIVISION.
    DISPLAY "MainBlocksMaximumStateId_TC-3 started".
    
    *> Accept result file path from environment
    ACCEPT WS-RESULT-FILE-PATH FROM ENVIRONMENT "RESULT_FILE_PATH"
    
    *> Initialize BLOCKS structure with test data (highest state ID = 2500)
    MOVE 3 TO BLOCK-COUNT
    MOVE 1000 TO BLOCK-ENTRY-MAXIMUM-STATE-ID(1)
    MOVE 2500 TO BLOCK-ENTRY-MAXIMUM-STATE-ID(2)
    MOVE 1500 TO BLOCK-ENTRY-MAXIMUM-STATE-ID(3)
    MOVE 2500 TO BLOCKS-MAXIMUM-STATE-ID
    ...
    *> Write outputs to file
    ...
    GOBACK.
END PROGRAM MainBlocksMaximumStateId_TC-3.
