*> --- Main-Blocks-Count-TC-5 ---
IDENTIFICATION DIVISION.
PROGRAM-ID. Main-Blocks-Count-TC-5.
...
PROCEDURE DIVISION.
    DISPLAY "Main-Blocks-Count-TC-5 started".
    
    *> Accept result file path from environment
    ACCEPT WS-RESULT-FILE-PATH FROM ENVIRONMENT "RESULT_FILE_PATH"
    
    *> Initialize BLOCKS structure with 10 entries
    MOVE 10 TO BLOCK-COUNT
    
    *> Remove 3 block entries by updating count
    SUBTRACT 3 FROM BLOCK-COUNT
