...
LookupId.
    ...
    IF LK-RESULT-ID <= 0 OR LK-RESULT-COUNT <= 0
        MOVE LK-RESULT-ID    TO NUMERIC-DISPLAY
        DISPLAY "Invalid recipe result: " FUNCTION TRIM(NUMERIC-DISPLAY) WITH NO ADVANCING
        MOVE LK-RESULT-COUNT TO NUMERIC-DISPLAY
        DISPLAY " x" FUNCTION TRIM(NUMERIC-DISPLAY)
